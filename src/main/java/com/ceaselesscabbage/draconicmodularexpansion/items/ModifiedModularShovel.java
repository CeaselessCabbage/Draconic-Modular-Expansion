...
public class ModifiedModularShovel extends ModularShovel{

	public ModifiedModularShovel(TechPropBuilder props) {
		super(props);
	}
	...
	public ModuleHostImpl createHost(ItemStack stack) {
        return new ModuleHostImpl(this.getTechLevel(), 4, 3, "shovel", removeInvalidModules);
    }
