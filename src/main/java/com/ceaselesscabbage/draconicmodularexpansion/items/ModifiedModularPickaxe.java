...
public class ModifiedModularPickaxe extends ModularPickaxe{

	public ModifiedModularPickaxe(TechPropBuilder props) {
		super(props);
	}
	...
	public ModuleHostImpl createHost(ItemStack stack) {
        return new ModuleHostImpl(this.getTechLevel(), 4, 3, "pickaxe", removeInvalidModules);
    }
