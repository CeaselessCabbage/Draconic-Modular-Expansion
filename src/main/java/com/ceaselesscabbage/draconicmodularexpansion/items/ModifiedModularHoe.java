...
public class ModifiedModularHoe extends ModularHoe{

	public ModifiedModularHoe(TechPropBuilder props) {
		super(props);
	}
	...
	public ModuleHostImpl createHost(ItemStack stack) {
        return new ModuleHostImpl(this.getTechLevel(), 4, 3, "hoe", removeInvalidModules);
    }
