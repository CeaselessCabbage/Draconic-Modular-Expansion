 ...
 */
public class ModifiedRenderModularChestpiece extends ModifiedToolRenderBase {
    ...
    public ModifiedRenderModularChestpiece(TechLevel techLevel) {
        super(techLevel, "chestpiece");
