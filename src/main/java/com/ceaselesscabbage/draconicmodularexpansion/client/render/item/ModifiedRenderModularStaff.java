 ...
 */
public class ModifiedRenderModularStaff extends ModifiedToolRenderBase {
    ...
    public ModifiedRenderModularStaff(TechLevel techLevel) {
    ...
    private final ItemOverrideList overrideList = new ItemOverrideList() {
        ...
        public IBakedModel resolve(IBakedModel originalModel, ItemStack stack, @Nullable ClientWorld world, @Nullable LivingEntity entity) {
            ModifiedRenderModularStaff.this.entity = entity;
            ModifiedRenderModularStaff.this.world = world == null ? entity == null ? null : (ClientWorld) entity.level : null;
