 ...
 */
public class ModifiedRenderModularBow extends ModifiedToolRenderBase {
    ...
    public ModifiedRenderModularBow(TechLevel techLevel) {
        super(techLevel, "bow");
        ...
        final RenderState.TransparencyState LIGHTNING_TRANSPARENCY = new RenderState.TransparencyState("lightning_transparency", () -> {
        ...
        final RenderState.WriteMaskState COLOR_WRITE = new RenderState.WriteMaskState(true, false);
        final RenderState.AlphaState DEFAULT_ALPHA = new RenderState.AlphaState(0.003921569F);
    ...
    private final ItemOverrideList overrideList = new ItemOverrideList() {
        ...
        public IBakedModel resolve(IBakedModel originalModel, ItemStack stack, @Nullable ClientWorld world, @Nullable LivingEntity entity) {
            ModifiedRenderModularBow.this.entity = entity;
            ModifiedRenderModularBow.this.world = world == null ? entity == null ? null : (ClientWorld) entity.level : null;
